...
class WinCardSetConfigTabController extends WinEditTabController {
  CardSetPO cardSet;
  ...
  @override
  String get tabId => "cardSetConfig-${cardSet.uuid}";

  @override
  void onInitState(BuildContext context) {
    super.onInitState(context);
    cardService = ServiceManager.of(context).cardStudyService;
    cardSetConfig.listen((item) {
      saveConfig();
    });
    readConfig();
  }
